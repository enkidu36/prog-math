...
var o10729 = temp__5455__auto__;
var temp__5455__auto____$1 = (o10729["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o10730 = temp__5455__auto____$1;
return (o10730["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__9841__auto__ = f;
return (o__9841__auto__["toString"]).call(o__9841__auto__);
} else {
return "";
}
}catch (e10731){var _ = e10731;
return "";
}});
...
try{var o__9841__auto___10733 = t;
(o__9841__auto___10733["cljs$lang$ctorPrWriter"]).call(o__9841__auto___10733,t,writer);
}catch (e10732){var __10734 = e10732;
}
...
var char_code = (function (){var o__9841__auto__ = (new String(char$));
return (o__9841__auto__["charCodeAt"]).call(o__9841__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__9841__auto__ = String;
return (o__9841__auto__["fromCharCode"]).call(o__9841__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__10735 = num_code;
switch (G__10735) {
case (1):
return (185);
...
var o__9841__auto__ = String;
return (o__9841__auto__["fromCharCode"]).call(o__9841__auto__,superscript_code);
});
/**
...
}catch (e10737){var _e__9848__auto__ = e10737;
return false;
}})())){
...
var vec__10738 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__10738,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o10741 = temp__5455__auto__;
var temp__5455__auto____$1 = (o10741["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o10742 = temp__5455__auto____$1;
return (o10742["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___10749 = arguments.length;
var i__4731__auto___10750 = (0);
while(true){
if((i__4731__auto___10750 < len__4730__auto___10749)){
args__4736__auto__.push((arguments[i__4731__auto___10750]));

var G__10751 = (i__4731__auto___10750 + (1));
i__4731__auto___10750 = G__10751;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__10745){
var vec__10746 = p__10745;
var ns_detector = cljs.core.nth.call(null,vec__10746,(0),null);
...
var G__10752 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__10753 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__10752;
remaining_tokens = G__10753;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq10743){
var G__10744 = cljs.core.first.call(null,seq10743);
var seq10743__$1 = cljs.core.next.call(null,seq10743);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10744,seq10743__$1);
});
...
var vec__10757 = cljs.core.split_with.call(null,(function (p1__10756_SHARP_){
return cljs.core.not_EQ_.call(null,p1__10756_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__10757,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__10757,(1),null);
...
var vec__10763 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__10763,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__10763,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__10766 = cljs.core.rest.call(null,remaining_tokens);
var G__10767 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__10766;
name_tokens = G__10767;
continue;
} else {
...
var vec__10770 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__10770,(0),null);
var arity = cljs.core.nth.call(null,vec__10770,(1),null);
var vec__10773 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__10773,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__10773,(1),null);
var vec__10776 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__10776,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__10776,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__10776,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__10776,(3),null);
...
var vec__10782 = result;
var munged_ns = cljs.core.nth.call(null,vec__10782,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__10782,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__10782,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__10782,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__10782,(4),null);
var arity = cljs.core.nth.call(null,vec__10782,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__10786 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__10786,(0),null);
var args = cljs.core.nth.call(null,vec__10786,(1),null);
var vec__10789 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__10789,(0),null);
var name = cljs.core.nth.call(null,vec__10789,(1),null);
...
var G__10792 = (arity + (1));
var G__10793 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__10794){
var vec__10795 = p__10794;
var arity = cljs.core.nth.call(null,vec__10795,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__10795,(1),null);
...
return cljs.core.get.call(null,arities,p1__10798_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__10799_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___10806 = arguments.length;
var i__4731__auto___10807 = (0);
while(true){
if((i__4731__auto___10807 < len__4730__auto___10806)){
args__4736__auto__.push((arguments[i__4731__auto___10807]));

var G__10808 = (i__4731__auto___10807 + (1));
i__4731__auto___10807 = G__10808;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__10802){
var vec__10803 = p__10802;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__10803,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq10800){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__10811__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__10811__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__10811__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__10811__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__10812 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__10812,(0),null);
var fn_name = cljs.core.nth.call(null,vec__10812,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__10812,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__10812,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__10812,(4),null);
var arity = cljs.core.nth.call(null,vec__10812,(5),null);
...
var o__9841__auto__ = f;
return (o__9841__auto__["getBasis"]).call(o__9841__auto__);
});
/**
...
}catch (e10816){var _e__9848__auto__ = e10816;
...
var G__10817 = (obj[cljs.core.first.call(null,path)]);
var G__10818 = cljs.core.rest.call(null,path);
obj = G__10817;
path = G__10818;
continue;
} else {
...
return (function (accum,p__10819){
var vec__10820 = p__10819;
var bit = cljs.core.nth.call(null,vec__10820,(0),null);
var protocol = cljs.core.nth.call(null,vec__10820,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__10823){
var vec__10824 = p__10823;
var ns = cljs.core.nth.call(null,vec__10824,(0),null);
var name = cljs.core.nth.call(null,vec__10824,(1),null);
var selector = cljs.core.nth.call(null,vec__10824,(2),null);
...
return (function (p__10828){
var vec__10829 = p__10828;
var munged_name = cljs.core.nth.call(null,vec__10829,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__10829,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__10829,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__10827_SHARP_){
return (obj[cljs.core.first.call(null,p1__10827_SHARP_)]);
});})(name,sorted_matches,vec__10829,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);

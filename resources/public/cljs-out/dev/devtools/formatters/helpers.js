...
var G__10834 = devtools.prefs.pref.call(null,v);
v = G__10834;
continue;
} else {
return v;
...
}catch (e10837){var _e__9848__auto__ = e10837;
return false;
}})();
...
}catch (e10841){var _e__9848__auto__ = e10841;
return false;
}})();
...
}catch (e10843){var _e__9848__auto__ = e10843;
return false;
}}
}
});
...
var vec__10845 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__10845,(0),null);
var name = cljs.core.nth.call(null,vec__10845,(1),null);
...
return cljs.core.some.call(null,(function (p1__10848_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__10848_SHARP_);
}),template);
});

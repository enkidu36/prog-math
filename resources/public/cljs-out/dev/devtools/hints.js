...
}catch (e11981){var _e = e11981;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___11984 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___11984)){
var seen_errors_11985 = temp__5455__auto___11984;
if(cljs.core.truth_(seen_errors_11985.has(self))){
} else {
seen_errors_11985.add(self);

var temp__5457__auto___11986 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___11986)){
var sense_11987 = temp__5457__auto___11986;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_11987)].join('');
} else {
}
}
} else {

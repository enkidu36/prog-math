...
cljs_test_display.notify.failure = (function cljs_test_display$notify$failure(p__8006){
var map__8007 = p__8006;
var map__8007__$1 = (((((!((map__8007 == null))))?(((((map__8007.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__8007.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8007):map__8007);
var error = cljs.core.get.call(null,map__8007__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var fail = cljs.core.get.call(null,map__8007__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
return cljs_test_display.notify.with_permission.call(null,"granted",((function (map__8007,map__8007__$1,error,fail){
return (function (){
...
});})(map__8007,map__8007__$1,error,fail))
);
});

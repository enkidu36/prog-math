...
var G__9470 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__9470,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__9470;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq9472){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9473,G__9474,seq9472__$2);
});
...
var file = cljs.core.get.call(null,map__9479__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__9479__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__9479__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__9479,map__9479__$1,file,line,column){
return (function (p1__9478_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__9478_SHARP_));
});})(map__9479,map__9479__$1,file,line,column))
...
var temp__5457__auto___9481 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___9481)){
var message_9482 = temp__5457__auto___9481;
cljs.core.println.call(null,message_9482);
} else {
}
...
var temp__5457__auto___9483 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___9483)){
var message_9484 = temp__5457__auto___9483;
cljs.core.println.call(null,message_9484);
} else {
}
...
var G__9487__$1 = (((G__9487 == null))?null:clojure.string.split_lines.call(null,G__9487));
var G__9487__$2 = (((G__9487__$1 == null))?null:cljs.core.get.call(null,G__9487__$1,depth));
if((G__9487__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__9487__$2);
}
} else {
...
var vec__9488 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__9488,(0),null);
var column = cljs.core.nth.call(null,vec__9488,(1),null);
var vec__9491 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__9491,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__9491,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__9491,(2),null);
...
var m__$1 = (function (){var G__9494 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__9498 = (function (){var G__9497 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__9497);
} else {
return G__9497;
}
})();
...
return cljs.core.vary_meta.call(null,G__9499,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__9503 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__9503,(0),null);
var types = vec__9503;
...
return cljs.core.map.call(null,(function (p__9506){
var vec__9507 = p__9506;
var ns = cljs.core.nth.call(null,vec__9507,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__9507,(1),null);
return ((function (vec__9507,ns,vars__$1){
return (function (){
...
var G__9510 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__9510,G__9510__$1,env,once_fixtures,each_fixtures,vec__9507,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__9510,G__9510__$1,env,once_fixtures,each_fixtures,vec__9507,ns,vars__$1){
return (function (){
var seq__9511 = cljs.core.seq.call(null,vars__$1);
var chunk__9512 = null;
var count__9513 = (0);
var i__9514 = (0);
while(true){
if((i__9514 < count__9513)){
var v = cljs.core._nth.call(null,chunk__9512,i__9514);
var temp__5457__auto___9516 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___9516)){
var t_9517 = temp__5457__auto___9516;
each_fixture_fn.call(null,((function (seq__9511,chunk__9512,count__9513,i__9514,t_9517,temp__5457__auto___9516,v,each_fixture_fn,G__9510,G__9510__$1,env,once_fixtures,each_fixtures,vec__9507,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_9517)));
});})(seq__9511,chunk__9512,count__9513,i__9514,t_9517,temp__5457__auto___9516,v,each_fixture_fn,G__9510,G__9510__$1,env,once_fixtures,each_fixtures,vec__9507,ns,vars__$1))
);
} else {
}


var G__9518 = seq__9511;
var G__9519 = chunk__9512;
var G__9520 = count__9513;
var G__9521 = (i__9514 + (1));
seq__9511 = G__9518;
chunk__9512 = G__9519;
count__9513 = G__9520;
i__9514 = G__9521;
...
var temp__5457__auto__ = cljs.core.seq.call(null,seq__9511);
if(temp__5457__auto__){
var seq__9511__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__9511__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__9511__$1);
var G__9522 = cljs.core.chunk_rest.call(null,seq__9511__$1);
var G__9523 = c__4550__auto__;
var G__9524 = cljs.core.count.call(null,c__4550__auto__);
var G__9525 = (0);
seq__9511 = G__9522;
chunk__9512 = G__9523;
count__9513 = G__9524;
...
var v = cljs.core.first.call(null,seq__9511__$1);
var temp__5457__auto___9526__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___9526__$1)){
var t_9527 = temp__5457__auto___9526__$1;
each_fixture_fn.call(null,((function (seq__9511,chunk__9512,count__9513,i__9514,t_9527,temp__5457__auto___9526__$1,v,seq__9511__$1,temp__5457__auto__,each_fixture_fn,G__9510,G__9510__$1,env,once_fixtures,each_fixtures,vec__9507,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_9527)));
});})(seq__9511,chunk__9512,count__9513,i__9514,t_9527,temp__5457__auto___9526__$1,v,seq__9511__$1,temp__5457__auto__,each_fixture_fn,G__9510,G__9510__$1,env,once_fixtures,each_fixtures,vec__9507,ns,vars__$1))
);
} else {
}


var G__9528 = cljs.core.next.call(null,seq__9511__$1);
var G__9529 = null;
var G__9530 = (0);
var G__9531 = (0);
seq__9511 = G__9528;
...
});})(each_fixture_fn,G__9510,G__9510__$1,env,once_fixtures,each_fixtures,vec__9507,ns,vars__$1))
);
});})(each_fixture_fn,G__9510,G__9510__$1,env,once_fixtures,each_fixtures,vec__9507,ns,vars__$1))
], null);
